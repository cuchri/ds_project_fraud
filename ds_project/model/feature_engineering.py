...
def cnt_purchase(device_id: str, is_existing_cust: bool, customer_hist: pd.DataFrame) -> int:
    ...
    """
    if is_existing_cust:
        return customer_hist[customer_hist['device_id'] == device_id]['cnt_purchase'].iloc[0] + 1
    else:
        return 1
...
def sec_since_last_purchase(device_id: str, dt_purchase: datetime, is_existing_cust: bool,
    ...
    if not is_existing_cust:
        ...
        dt_last_purchase = customer_hist[customer_hist['device_id'] == device_id]['dt_last_purchase'].iloc[0]
